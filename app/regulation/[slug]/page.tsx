...
import { REGULATION_BY_SLUG_QUERY } from "@/sanity/lib/queries";
...
const REGULATIONS: Record<string, RegulationData> = {
  csrd: {
    ...
    sections: [
      ...
      {
        id: "csrd-section-econ",
        head: "Key economic implications",
        paragraphs: [
    ...
    sources: [
      {
        text: "Directive (EU) 2026/470, Official Journal 26 February 2026 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202600470",
      },
    ],
  },
  ...
  esrs: {
    ...
    keyDates:
      "Simplified ESRS delegated act due: 18 September 2026\n\nFirst reporting under simplified ESRS: 2028 (FY2027)\n\nOriginal ESRS Set 1 adopted: July 2023 (reference only)",
    sections: [
      {
        id: "esrs-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "EFRAG ESRS project page ↗",
        href: "https://www.efrag.org/en/projects/esrs-mandatory-for-csrd",
      },
    ],
  },
  ...
  dpp: {
    ...
    badgeClass: "badge--transpos",
    title: "DPP",
    fullName: "Digital Product Passport (Textiles)",
    summary:
    ...
    keyDates:
      "Textile DPP delegated act expected: 2027\n\nAnticipated enforcement start: mid-2028\n\nESPR framework regulation in force: 18 July 2024",
    sections: [
      {
        id: "dpp-section-what",
        head: "What it is",
    ...
    sources: [
      {
        text: "ESPR Regulation (EU) 2024/1781, Official Journal 28 June 2024 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202401781",
      },
    ],
  },

  "textile-labelling": {
    slug: "textile-labelling",
    badgeClass: "badge--preparation",
    title: "Textile labelling revision",
    fullName: "EU Textile Labelling Regulation Revision",
    summary:
    ...
    keyDates:
      "Current status: indefinitely delayed, no confirmed timeline\n\nExpected absorption pathway: textile DPP delegated act (anticipated 2027)\n\nExisting regulation (1007/2011): remains in force unchanged",
    sections: [
      {
        id: "textile-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "European Commission, textile strategy communication ↗",
        href: "https://ec.europa.eu/commission/presscorner/detail/en/ip_23_4328",
      },
    ],
  },
  ...
  ecgt: {
    slug: "ecgt",
    badgeClass: "badge--in-force",
    title: "ECGT",
    fullName: "Empowering Consumers for Green Transition Directive",
    summary:
    ...
    keyDates:
      "Transposition deadline: 27 March 2026\n\nApplies to businesses: 27 September 2026\n\nPublished in Official Journal: March 2024",
    sections: [
      {
        id: "ecgt-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "Directive (EU) 2024/825 ↗",
        href: "https://eur-lex.europa.eu/eli/dir/2024/825/oj/eng",
      },
    ],
  },

  "green-claims-directive": {
    slug: "green-claims-directive",
    badgeClass: "badge--preparation",
    title: "Green Claims Directive",
    fullName: "EU Green Claims Directive",
    summary:
    ...
    keyDates:
      "Original proposal published: March 2023\n\nLegislative process suspended: June 2025\n\nNo confirmed revival date as of early 2026",
    sections: [
      {
        id: "gcd-section-what",
        head: "What it is",
    ...
    sources: [
      {
        text: "European Commission proposal communication (March 2023) ↗",
        href: "https://ec.europa.eu/commission/presscorner/detail/en/ip_23_2035",
      },
    ],
  },
  ...
  csddd: {
    ...
    keyDates:
      "Omnibus I in force: 18 March 2026\n\nMember state transposition deadline: 26 July 2028\n\nIn-scope company compliance required: 26 July 2029",
    sections: [
      {
        id: "csddd-section-what",
        head: "What it is",
        paragraphs: [
  ...
  eudr: {
    ...
    keyDates:
      "Enforcement for large operators: 30 December 2026\n\nEnforcement for small/micro operators: 30 June 2027\n\nAmendment regulation published: 23 December 2025",
    sections: [
      {
        id: "eudr-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "Regulation (EU) 2025/2650, Official Journal 23 December 2025 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202502650",
      },
    ],
  },
  ...
  espr: {
    ...
    keyDates:
      "Unsold goods destruction ban (large companies): 19 July 2026\n\nUnsold goods destruction ban (medium companies): 19 July 2030\n\nTextile ecodesign delegated act expected: 2027",
    sections: [
      {
        id: "espr-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "Regulation (EU) 2024/1781, Official Journal 28 June 2024 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202401781",
      },
    ],
  },
  ...
  "textile-epr": {
    slug: "textile-epr",
    badgeClass: "badge--in-force",
    title: "EU Textile EPR",
    fullName: "Extended Producer Responsibility — Textiles (Directive 2025/1892)",
    summary:
    ...
    keyDates:
      "Separate textile collection mandatory across EU: January 2025\n\nDirective in force: 16 October 2025\n\nNational EPR schemes operational: 17 April 2028",
    sections: [
      {
        id: "epr-section-what",
        head: "What it is",
    ...
    sources: [
      {
        text: "Directive (EU) 2025/1892 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202501892",
      },
    ],
  },
  ...
  ppwr: {
    ...
    keyDates:
      "General application: 12 August 2026\n\nDigital labelling (QR codes): 2027\n\nHarmonised material labels: 12 August 2028\n\nSpace efficiency and recycled content targets: 2030",
    sections: [
      {
        id: "ppwr-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "Regulation (EU) 2025/40, Official Journal 22 January 2025 ↗",
        href: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202500040",
      },
    ],
  },

  "france-eco-score": {
    slug: "france-eco-score",
    badgeClass: "badge--in-force",
    title: "France eco-score",
    fullName: "France Textile Environmental Score",
    summary:
    ...
    keyDates:
      "Voluntary scheme open / mandatory for brands making any environmental claims: October 2025\n\nThird-party publication right activates: October 2026",
    sections: [
      {
        id: "france-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "French Ministry of Ecological Transition: affichage environnemental ↗",
        href: "https://www.ecologie.gouv.fr/affichage-environnemental-des-produits-textiles",
      },
    ],
  },
  ...
  "italy-ddl": {
    slug: "italy-ddl",
    badgeClass: "badge--preparation",
    title: "Italy fast fashion bill",
    fullName: "Italy DDL S.1690 Fast Fashion Bill",
    summary:
    ...
    keyDates:
      "Bill introduced to Senate: October 2025\n\nCurrent status: under parliamentary review, no confirmed vote date\n\nSeparate parcel levy (Budget Act 2026): already in force",
    sections: [
      {
        id: "italy-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "Italian Parliament, DDL S.1690 (Senato della Repubblica) ↗",
        href: "https://www.senato.it/leg/19/BGT/Schede/FascicoloSchedeDDL/ebook/57071.pdf",
      },
    ],
  },

  "california-sb707": {
    slug: "california-sb707",
    badgeClass: "badge--in-force",
    title: "California SB 707",
    fullName: "California Textile Extended Producer Responsibility Act",
    summary:
    ...
    keyDates:
      "PRO (Landbell USA) approved: February 2026\n\nProducer registration deadline: July 2026\n\nFull enforcement regulations and programme: July 2028 to 2030",
    sections: [
      {
        id: "sb707-section-what",
        head: "What it is",
        paragraphs: [
    ...
    sources: [
      {
        text: "SB 707 legislative text, California Legislature ↗",
        href: "https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202320240SB707",
      },
    ],
  },
};
...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  if (!reg) return { title: "Regulation — Prefall" };
  return {
    title: `${reg.title} — Prefall`,
...
export default async function RegulationPage({ params }: Params) {
  ...
  // Optionally fetch from Sanity for status/dates override — always falls back to hardcoded content
  let sanityData: { status?: string; effectiveDate?: string } | null = null;
  if (isSanityConfigured()) {
    try {
      sanityData = await client.fetch(REGULATION_BY_SLUG_QUERY, { slug });
    } catch {
      // Silently fall back to hardcoded data
    }
  }

  // On-this-page links derived from sections plus sources
  const onThisPageLinks = [
    ...reg.sections.map((s) => ({ id: s.id, label: s.head })),
    { id: `${slug}-section-sources`, label: "Sources" },
  ];

  // Key dates: split on double newline
  const keyDateLines = reg.keyDates.split("\n\n");
    ...
    <>
      ...
      <div className="detail-header">
        <div className="detail-header__label">
          <Link className="detail-header__back" href="/regulation">
            ← Regulation
          </Link>
          <span className={`badge ${reg.badgeClass}`}>
            {reg.badgeClass === "badge--amended"
              ? "Amended"
              : reg.badgeClass === "badge--in-force"
              ? "In force"
              : reg.badgeClass === "badge--transpos"
              ? "Enforcement pending"
              : "Proposed"}
          </span>
        </div>
        <h1 className="detail-header__heading">{reg.title}</h1>
        <p className="detail-header__full">{reg.fullName}</p>
        <p className="detail-header__summary">{reg.summary}</p>
      </div>
      ...
      <div className="detail-wrap">
        <div className="detail-layout">
          ...
          <nav className="detail-sidebar">
            ...
            <div className="detail-sidebar__section">
              <button className="detail-sidebar__trigger">
                Key dates<span className="detail-sidebar__icon">+</span>
              </button>
              <div className="detail-sidebar__panel">
                <p className="detail-sidebar__text">
                  {keyDateLines.map((line, i) => (
                    <span key={i}>
                      {line}
                      {i < keyDateLines.length - 1 && (
                        <>
                          <br />
                          <br />
                        </>
          ...
          <div>
            {reg.sections.map((section) => (
              <div
                key={section.id}
                className="detail-body__section"
                id={section.id}
              >
                <p className="detail-body__section-head">{section.head}</p>
                {section.paragraphs.map((para, i) => (
                  <p key={i} className="detail-body__prose">
                    {para}
                  </p>
                ))}
              </div>
            ...
            <div
              className="detail-body__section"
              id={`${slug.replace(/-/g, "").replace(/[^a-z0-9]/gi, "")}-section-sources`}
            >
              <p className="detail-body__section-head">Official sources</p>
              <ul className="modal__list">
                {reg.sources.map((source, i) => (
                  <li key={i}>
